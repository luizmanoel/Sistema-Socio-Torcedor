 ...
 * @author Luiz Manoel
 */
public class TelaAlterarAdmin extends javax.swing.JFrame {
     ...
     */
    public TelaAlterarAdmin() {
        
        initComponents();
        preenche();
    }

    public TelaAlterarAdmin(Administrador adm) {
        this.adm = adm;       
        initComponents();
    ...
    public void preenche(){//Preenche quando tela eh chamada
        jTextNome.setText(getAdm().getNome());
        //jTextCargo.setText(getAdm().getCargo());
        ...
        this.jTextEndNum.setText(getAdm().getEndereco().getEndNum());
        this.jTextEndRua.setText(getAdm().getEndereco().getEndRua());
        this.jTextEndCidade.setText(getAdm().getEndereco().getEndCidade());
        this.jTextEndEstado.setText(getAdm().getEndereco().getEndEstado());//Email, Telefone X
        ...
        jTextSalario.setText(String.valueOf((int)getAdm().getSalario()));
        getAdm().setSexo(jComboSexo.getSelectedItem().toString().charAt(0));
    ...
    public void alterarAdministrador(){
        ...
        adm.setEndereco(end1);
        
        
        adm.setCpf(this.jTextCpf.getText());
...
//        func.getTelefone().add(tel1);
        ...
        adm.setIdade(Integer.parseInt(this.jComboIdade.getSelectedItem().toString()));
        adm.setNome(this.jTextNome.getText());
        adm.setSexo(jComboSexo.getSelectedItem().toString().charAt(0));
        
        adm.setSalario(Integer.parseInt(this.jTextSalario.getText()));
        adm.setSenha(jTextSenha.getText());
        
        FuncionarioDAO funcDAO = new FuncionarioDAO();
        funcDAO.altera(adm);//Possivel Correçao
...
//        }
    ...
    private void jButtonEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEmailActionPerformed
        // TODO add your handling code here:
        TelaAlterarEmail telaEmail = new TelaAlterarEmail(this.adm.getEmail());
    ...
    private void jButtonTelefoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTelefoneActionPerformed
        // TODO add your handling code here:
        TelaAlterarTelefone telaTel = new TelaAlterarTelefone(this.adm.getTelefone());
...
//    }
    ...
    public void setFunc(Administrador adm) {
        this.adm = adm;
    }
}
