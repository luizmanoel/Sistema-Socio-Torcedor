 ...
 * @author Luiz Manoel
 */
public class TelaListaAlteracaoFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form TelaListaDeSTs
     */
    public TelaListaAlteracaoFuncionario() {
        initComponents();
        preenche();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaAlteracaoFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaAlteracaoFuncionario().setVisible(true);
            }
        });
    }
