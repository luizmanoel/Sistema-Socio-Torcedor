 ...
 * @author Luiz Manoel
 */
public class TelaListaAlteracaoST extends javax.swing.JFrame {

    /**
     * Creates new form TelaListaDeSTs
     */
    public TelaListaAlteracaoST() {
        initComponents();
        preenche();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaAlteracaoST.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaAlteracaoST().setVisible(true);
            }
        });
    }
